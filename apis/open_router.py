...
class OpenRouter:
    ...
    def infer(self, model_name='meta-llama/llama-4-scout', image_path=None, prompt=None):
        ...
        glm-4.1v-9b-thinking: https://openrouter.ai/thudm/glm-4.1v-9b-thinking/api
        
        x-ai/grok-2-vision-1212: https://openrouter.ai/x-ai/grok-2-vision-1212/api
        
        openai/gpt-5: https://openrouter.ai/openai/gpt-5/api
        openai/gpt-5-mini:  https://openrouter.ai/openai/gpt-5-mini/api
        openai/gpt-4o: https://openrouter.ai/openai/gpt-4.1-nano
        openai/gpt-4o-mini: https://openrouter.ai/openai/gpt-4o-mini/api
        openai/gpt-o4-mini: https://openrouter.ai/openai/gpt-4o-mini/api
        ...
        anthropic/claude-sonnet-4: https://openrouter.ai/anthropic/claude-sonnet-4/api
        '''
